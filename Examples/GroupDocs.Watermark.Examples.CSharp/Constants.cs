...
namespace GroupDocs.Watermark.Examples.CSharp
{
    public static class Constants
    {
        ...
        public static readonly string OutMessageMsg = Path.Combine(OutputPath, "test.msg");
        ...
        public static readonly string OutSpreadsheetXlsx = Path.Combine(OutputPath, "document.xlsx");
