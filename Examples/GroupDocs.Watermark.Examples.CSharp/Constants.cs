...
namespace GroupDocs.Watermark.Examples.CSharp
{
    ...
    public static class Constants
    {
        ...
        public static readonly string OutDiagramVsdx = Path.Combine(OutputPath, "diagram.vsdx");
        public static readonly string InDocumentDocx = Path.Combine(DocumentsPath, "document.docx");
        public static readonly string OutDocumentDocx = Path.Combine(OutputPath, "document.docx");
        public static readonly string InDocumentPdf = Path.Combine(DocumentsPath, "document.pdf");
        public static readonly string OutDocumentPdf = Path.Combine(OutputPath, "document.pdf");
        public static readonly string InDocumentXlsx = Path.Combine(DocumentsPath, "document.xlsx");
        public static readonly string OutDocumentXlsx = Path.Combine(OutputPath, "document.xlsx");
        public static readonly string InImagePng = Path.Combine(DocumentsPath, "image.png");
        public static readonly string OutImagePng = Path.Combine(OutputPath, "image.png");
        public static readonly string InImageTiff = Path.Combine(DocumentsPath, "image.tiff");
        public static readonly string OutImageTiff = Path.Combine(OutputPath, "image.tiff");
        public static readonly string InInputVsdx = Path.Combine(DocumentsPath, "input.vsdx");
        public static readonly string OutInputVsdx = Path.Combine(OutputPath, "input.vsdx");
        public static readonly string InMessageMsg = Path.Combine(DocumentsPath, "message.msg");
        public static readonly string OutMessageMsg = Path.Combine(OutputPath, "message.msg");
        public static readonly string InPresentationPptx = Path.Combine(DocumentsPath, "presentation.pptx");
        public static readonly string OutPresentationPptx = Path.Combine(OutputPath, "presentation.pptx");
        public static readonly string InProtectedDocumentDocx = Path.Combine(DocumentsPath, "protected-document.docx");
        public static readonly string OutProtectedDocumentDocx = Path.Combine(OutputPath, "protected-document.docx");
        public static readonly string InSampleDocx = Path.Combine(DocumentsPath, "sample.docx");
        public static readonly string InSampleMsg = Path.Combine(DocumentsPath, "sample.msg");
        public static readonly string InSourceDocx = Path.Combine(DocumentsPath, "source.docx");
        public static readonly string InSpreadsheetXlsx = Path.Combine(DocumentsPath, "spreadsheet.xlsx");
        public static readonly string OutSpreadsheetXlsx = Path.Combine(OutputPath, "spreadsheet.xlsx");
        public static readonly string InTestDoc = Path.Combine(DocumentsPath, "test.doc");
        public static readonly string OutTestDoc = Path.Combine(OutputPath, "test.doc");
        public static readonly string InTestDocx = Path.Combine(DocumentsPath, "test.docx");
        public static readonly string OutTestDocx = Path.Combine(OutputPath, "test.docx");
